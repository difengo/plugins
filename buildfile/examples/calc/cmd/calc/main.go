...
import (
	...
	calc "goa.design/plugins/buildfile/examples/calc"
	calcsvc "goa.design/plugins/buildfile/examples/calc/gen/calc"
	calcsvcsvr "goa.design/plugins/buildfile/examples/calc/gen/http/calc/server"
)
