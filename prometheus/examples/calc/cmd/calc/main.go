...
import (
	...
	calc "goa.design/plugins/prometheus/examples/calc"
	calcsvc "goa.design/plugins/prometheus/examples/calc/gen/calc"
	calcsvcsvr "goa.design/plugins/prometheus/examples/calc/gen/http/calc/server"
)
