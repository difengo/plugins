...
import (
	...
	calcsvcc "goa.design/plugins/prometheus/examples/calc/gen/http/calc/client"
)
...
func UsageCommands() string {
	return `calc (add|metrics)
`
}

// UsageExamples produces an example of a valid invocation of the CLI tool.
func UsageExamples() string {
	return os.Args[0] + ` calc add --a 8399553735696626949 --b 360622074634248926` + "\n" +
		""
}
...
func ParseEndpoint(
	...
	var (
		...
		calcMetricsFlags = flag.NewFlagSet("metrics", flag.ExitOnError)
	)
	calcFlags.Usage = calcUsage
	calcAddFlags.Usage = calcAddUsage
	calcMetricsFlags.Usage = calcMetricsUsage
...
Example:
    `+os.Args[0]+` calc add --a 8399553735696626949 --b 360622074634248926
`, os.Args[0])
}

func calcMetricsUsage() {
	fmt.Fprintf(os.Stderr, `%s [flags] calc metrics

Prometheus metrics endpoint.

Example:
    `+os.Args[0]+` calc metrics
`, os.Args[0])
}
