...
import (
	...
	calc "goa.design/plugins/readme/examples/calc"
	calcsvc "goa.design/plugins/readme/examples/calc/gen/calc"
	calcsvcsvr "goa.design/plugins/readme/examples/calc/gen/http/calc/server"
)
