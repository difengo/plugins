...
import (
	...
	calc "goa.design/plugins/dockerfile/examples/calc"
	calcsvc "goa.design/plugins/dockerfile/examples/calc/gen/calc"
	calcsvcsvr "goa.design/plugins/dockerfile/examples/calc/gen/http/calc/server"
)
