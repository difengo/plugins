...
import (
	...
	cli "goa.design/plugins/dockerfile/examples/calc/gen/http/cli/calc"
)

func main() {
	var (
		addr = flag.String("url", "http://localhost:80/calc", "`URL` to service host")
...
Usage:
    ...
    -url URL:    specify service URL (http://localhost:80/calc)
